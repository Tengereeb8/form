    ...
    <div className="flex flex-col gap-6 ">
      ...
      <div className="flex gap-2 mt-4">
        <button
          type="button"
          onClick={handledPrevStep}
          className="flex-1 h-11 border border-gray-300 rounded-md font-medium text-gray-700 hover:bg-gray-50"
        >
          Back
        </button>
        <button
          type="button"
          onClick={handleNext}
          className="flex-1 h-11 text-white bg-[#121316] rounded-md font-medium hover:bg-black transition-colors"
        >
          Submit
        </button>
      </div>
